...
title: "C'mon C'mon: Let's Have a Pointblank Workshop!"
author: Rich Iannone
date: 2025-06-03
freeze: true
---

Recently, I've been giving workshops to data teams on Pointblank. These sorts of engagements
...
reach out at rich@posit.co or message me on the Pointblank Discord
([link to Pointblank server](https://discord.com/invite/YH7CybCNCQ)).
...
providing a workshop to data teams (at no cost). If this sounds interesting to you please feel free
to contact me through email or via Discord. Don't be shy. Just know that if you have a need for data
validation, we're here to help!
