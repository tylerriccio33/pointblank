...
![](validation-three-things.png){style="width: 80%; text-align: center;"}
...
![](breadth-and-depth.png){style="width: 50%; text-align: center;"}
...
![](explanation-of-visual.png){style="width: 80%; text-align: center;"}
...
![](links-in-guide.png){style="width: 80%; text-align: center;"}
...
![](advanced-in-sidebar.png){style="width: 35%; text-align: center;"}
...
![](segments.png){style="width: 80%; text-align: center;"}
...
[Segmentation article in the User Guide](../../user-guide/segmentation.qmd) to get a feel for how
each location documents the segments feature.
...
![](step-report.png){style="width: 80%; text-align: center;"}
