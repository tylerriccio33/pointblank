...
![](validation-three-things.png){width=80%, text-align=center}
...
![](breadth-and-depth.png){width=50%, text-align=center}
...
![](explanation-of-visual.png){width=80%, text-align=center}
...
![](links-in-guide.png){width=80%, text-align=center}
...
![](advanced-in-sidebar.png){width=35%, text-align=center}
...
![](segments.png){width=80%, text-align=center}
...
![](step-report.png){width=80%, text-align=center}
