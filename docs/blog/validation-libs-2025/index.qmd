...
# Create DataFrame with library information
library_features = pl.DataFrame(
    {
        ...
        "stars": [3835, 463, 166, 62, 315],
        "feat": [
            "Statistical testing, schema-first validation, mypy integration",
            "Pydantic integration, model-based validation, serialization",
