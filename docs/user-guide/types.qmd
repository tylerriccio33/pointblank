...
- [Column selection patterns](columns.qmd) for targeting multiple columns efficiently
...
article in this guide covers [column selection patterns](columns.qmd) to help you target validation
methods at multiple columns efficiently.
