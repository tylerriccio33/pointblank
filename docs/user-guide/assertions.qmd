...
1. **Full Passing Assertions**: using
[`assert_passing()`](https://posit-dev.github.io/pointblank/reference/Validate.assert_passing.html)
to verify that every single test unit passes
2. **Threshold-Based Assertions**: using
...
[`assert_passing()`](https://posit-dev.github.io/pointblank/reference/Validate.assert_passing.html)
and [`assert_below_threshold()`](https://posit-dev.github.io/pointblank/reference/Validate.assert_below_threshold.html)
will automatically call [`interrogate()`](https://posit-dev.github.io/pointblank/reference/Validate.interrogate.html)
...
[`critical()`](https://posit-dev.github.io/pointblank/reference/Validate.critical.html)) return
