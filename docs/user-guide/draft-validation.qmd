...
The
[`DraftValidation`](https://posit-dev.github.io/pointblank/reference/DraftValidation.html) class
connects to various LLM providers to analyze your data's characteristics and generate a complete
validation plan tailored to its structure and content.

## How `DraftValidation` Works

When you use
[`DraftValidation`](https://posit-dev.github.io/pointblank/reference/DraftValidation.html), the
process works through these steps:

1. A statistical summary of your data is generated using the
[`DataScan`](https://posit-dev.github.io/pointblank/reference/DataScan.html) class
...
The entire process happens without sending your actual data to the LLM provider, only a summary that
includes column names, data types, basic statistics, and a small sample of values.

## Requirements and Setup

To use the [`DraftValidation`](https://posit-dev.github.io/pointblank/reference/DraftValidation.html)
feature, you'll need:
...
This will install the `chatlas` package and other dependencies required for
[`DraftValidation`](https://posit-dev.github.io/pointblank/reference/DraftValidation.html).

### Supported LLM Providers

The [`DraftValidation`](https://posit-dev.github.io/pointblank/reference/DraftValidation.html) class
...
[`DraftValidation`](https://posit-dev.github.io/pointblank/reference/DraftValidation.html) is to
provide your data and specify an LLM model. Let's try it out with the `global_sales` dataset.
...
[`DraftValidation`](https://posit-dev.github.io/pointblank/reference/DraftValidation.html) will
...
Here's an example of a validation plan that might be generated by
[`DraftValidation`](https://posit-dev.github.io/pointblank/reference/DraftValidation.html) for the
`nycflights` dataset:
...
When using [`DraftValidation`](https://posit-dev.github.io/pointblank/reference/DraftValidation.html),
...
A key advantage of
[`DraftValidation`](https://posit-dev.github.io/pointblank/reference/DraftValidation.html) is that
your actual dataset is not sent to the LLM provider. Instead, only a summary is transmitted, which
includes:
...
The validation plan generated by
[`DraftValidation`](https://posit-dev.github.io/pointblank/reference/DraftValidation.html) is just a
starting point. You'll typically want to:
...
1. Use the schema information to create a
[`Schema`](https://posit-dev.github.io/pointblank/reference/Schema.html) object
2. Include
[`col_vals_not_null()`](https://posit-dev.github.io/pointblank/reference/Validate.col_vals_not_null.html)
for columns with no missing values
...
A recommended workflow incorporating
[`DraftValidation`](https://posit-dev.github.io/pointblank/reference/DraftValidation.html):

1. Generate an initial plan with
[`DraftValidation`](https://posit-dev.github.io/pointblank/reference/DraftValidation.html)
...
- **Authentication Errors**: ensure your API key is valid and correctly passed to the constructor
...
Be aware that LLM providers typically have rate limits. If you're generating many validation plans,
consider using local models through Ollama, implementing rate limiting in your code, or caching
generated plans for datasets that don't change frequently.

## Conclusion

[`DraftValidation`](https://posit-dev.github.io/pointblank/reference/DraftValidation.html) provides
a powerful way to jumpstart your data validation process by leveraging LLMs to generate
context-aware validation plans. By analyzing your data's structure and content,
[`DraftValidation`](https://posit-dev.github.io/pointblank/reference/DraftValidation.html) can
create comprehensive validation rules that would otherwise take significant time to develop
manually.
...
[`DraftValidation`](https://posit-dev.github.io/pointblank/reference/DraftValidation.html) works and
how to customize its output, you can significantly accelerate your data validation workflows and
improve the quality of your data throughout your projects.
