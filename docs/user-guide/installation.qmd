...
flexibility to choose either Pandas or Polars:
...
Pointblank's reporting functionality (powered by Great Tables) requires a DataFrame library for
rendering tabular reporting results.
:::
