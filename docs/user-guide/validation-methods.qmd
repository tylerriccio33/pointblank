...
[`col_vals_lt()`](https://posit-dev.github.io/pointblank/reference/Validate.col_vals_lt.html), etc.)
for comparing values to thresholds or other columns
...
for verifying values fall within or outside specific ranges
...
for validating values against predefined sets
...
for testing presence or absence of null values

- **Pattern matching checks**
([`col_vals_regex()`](https://posit-dev.github.io/pointblank/reference/Validate.col_vals_regex.html))
for validating text patterns with regular expressions
