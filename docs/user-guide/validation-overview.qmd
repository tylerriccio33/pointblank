...
the [`Validate`](https://posit-dev.github.io/pointblank/reference/Validate.html) class. When
combined they create a comprehensive validation plan for your data.
